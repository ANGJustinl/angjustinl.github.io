---
title: Steam Profile Widget
date: 2025-05-30 16:02:07
tags: [AI, Web, 学习]
categories: [Web]
mathjax: true
thumbnail: ""
...
1. **下载文件**
   - `steam-profile-widget.js` - 主要的widget文件 [从我的cdn](https://upyuncloud.angforever.top/js/steam_profile_widget/v0.1/steam-profile-widget.js)
...
<script src="https://upyuncloud.angforever.top/js/steam_profile_widget/v0.1/steam-profile-widget.js"></script>
```
